...
import ir.hrka.kotlin.domain.usecases.db.GetDBKotlinTopicsUseCase
import ir.hrka.kotlin.domain.usecases.db.RemoveDBKotlinTopicsUseCase
import ir.hrka.kotlin.domain.usecases.git.GetGitKotlinTopicsUseCase
import ir.hrka.kotlin.domain.usecases.db.SaveKotlinTopicsOnDBUseCase
import ir.hrka.kotlin.domain.usecases.preference.SaveKotlinVersionIdUseCase
import ir.hrka.kotlin.domain.usecases.db.UpdateKotlinTopicsStateOnDBUseCase
...
class TopicViewModel @Inject constructor(
    ...
    private val updateKotlinTopicsStateOnDBUseCase: UpdateKotlinTopicsStateOnDBUseCase
) : ViewModel() {
    ...
    fun updateKotlinTopicsOnDB() {
        viewModelScope.launch(io) {
            ...
            updateKotlinTopicsStateOnDBUseCase(
