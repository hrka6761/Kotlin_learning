package ir.hrka.kotlin.presentation.screens.visualizers.coroutine_scope_function
...
@Composable
fun CoroutineScopeFunctionScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                modifier = modifier,
                title = stringResource(R.string.coroutine_scope_function_app_bar_title),
        ...
        Column(
            ...
            VisualizerSnippetCodeDialog(
                ...
                description = stringResource(R.string.coroutine_scope_function_screen_snippet_code_dialog_desc),
                snippetCode = stringResource(R.string.coroutine_scope_function_screen_snippet_code_dialog_code)
            )
        }
    }
...
@Composable
fun CoroutineScopeFunctionScreenPreview() {
