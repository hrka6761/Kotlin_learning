package ir.hrka.kotlin.presentation.screens.visualizers.coroutines
...
fun CoroutinesScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                modifier = modifier,
                title = stringResource(R.string.coroutines_app_bar_title),
        ...
        Column(
            ...
            VisualizerSnippetCodeDialog(
                ...
                description = stringResource(R.string.coroutine_screen_snippet_code_dialog_desc),
                snippetCode = stringResource(R.string.coroutine_screen_snippet_code_dialog_code)
            )
        }
    }
