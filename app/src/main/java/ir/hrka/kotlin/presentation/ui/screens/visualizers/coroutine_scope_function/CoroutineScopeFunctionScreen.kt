...
fun CoroutineScopeFunctionScreen(activity: MainActivity, navHostController: NavHostController) {
    ...
    Scaffold(
        ...
        topBar = { CoroutineScopeFunctionScreenAppBar(navHostController, viewModel, executionState) },
        snackbarHost = {
            SnackbarHost(
                modifier = Modifier
                    .fillMaxWidth(),
    ...
    TopAppBar(
        title = {
            Text(
                ...
                text = stringResource(R.string.coroutine_scope_function_app_bar_title),
...
fun CoroutineScopeFunctionScreenPreview() {
    CoroutineScopeFunctionScreen(MainActivity(), rememberNavController())
}
