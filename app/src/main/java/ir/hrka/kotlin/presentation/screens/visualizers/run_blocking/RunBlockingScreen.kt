...
fun RunBlockingScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                modifier = modifier,
                title = stringResource(R.string.run_blocking_app_bar_title),
        ...
        Column(
            ...
            VisualizerSnippetCodeDialog(
                ...
                description = stringResource(R.string.runblocking_screen_snippet_code_dialog_desc),
                snippetCode = stringResource(R.string.runblocking_screen_snippet_code_dialog_code)
            )
        }
    }
